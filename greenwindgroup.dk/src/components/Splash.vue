        ...
        .columns
          ...
          .column.is-6
            ...
            //- .lang
              ...
              a(v-on:click="setLang('dk')", class="isActive") dk
              span.divider /
              a(href='http://greenwind.berlin/') de
              span.divider /
              a(href='http://greenwind.berlin/?lang=en') en

            .contact
              span
                button(id="show-modal", @click="showModal = true") {{ c.contactTitle }}
              span
                router-link(:to='imprintLink') {{ imprintTitle }}
              span
        ...
        .inner
          .popuptext
            .popuplogo
              ...
              img(src='../assets/svg/splash/popup-july-2019/date2.svg').date
              img(src='../assets/svg/splash/new/new-gw-logo-en.svg').l
            //- .txt Find us here: 5B27
            h2 Velkommen til Green Wind i Danmark!
            p Den tyske virksomhed Green Wind har overtaget begge de danske virksomheder ECOPARTNER og FWE Administration ApS. For eksisterende kunder i begge virksomheder fastholdes alle forretningskontakter og virksomhedsadresser i København og Aarhus. Hvilke kompetencer Green Wind også kan tilbyde på det danske vindmarked, finder du på vores webside, som vi nu løbende udvider for Danmark.
            p Siden grundlæggelsen i 2011, som en uafhængig virksomhed med hovedkontor i Berlin, plejer vi tætte kontakter til aktører i den danske vindbranche. Nu kan vi som en erfaren Tysk projektudvikler i repowering spørgsmål, og som specialist i teknisk og erhvervsmæssig styring, såvel onshore som offshore, stille al vores know-how til rådighed for det danske marked.
            p Vi glæder os over den nye udfordring med vindens kraft.
            p
              | Martin Kühl, CEO
              br
    ...
    .modal.is-active(v-if="showModal")
      ...
      .modal-card
        ...
        section.modal-card-body
          p
            | Green Wind Denmark ApS
            | Egå Havvej 21
            | DK-8250 Egå
          p
            | Telefon: +45 8622 6200
            | Mobil: +45 2080 0207
          p
            | E-mail:&nbsp;

            a(href="mailto:info@greenwindgroup.dk") info@greenwindgroup.dk
            //- a(href="mailto:eso@ecopartner.dk") eso@ecopartner.dk
            //- | Email Energy:&nbsp;
                ...
                .cr_ipe_item
                  ...
                  div
                    .lang
                      ...
                      a(href='https://greenwind.berlin') de
                      span.divider /
                      //- a(v-on:click="setLang('en')", :class="isActive('en')") en
                      a(href='https://greenwind.berlin') en
                      span.divider /
                      strong dk
...
export default {
  ...
  created () {
    ...
    //   lang = this.URLlang
    // } else {
    //   lang = (typeof localStorage.getItem('greenwindLang') !== 'undefined' && localStorage.getItem('greenwindLang')) || 'dk'
    // }
    // this.lang = lang
...
.startPopUp
  ...
  border-radius: 2em
  // background-image: url(../assets/img/GW-Logo-dk-1.jpg)
