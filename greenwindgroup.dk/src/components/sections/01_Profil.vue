      ...
      .container.content
        .columns
          .text.column.is-6(:class="section==='operations' ? 'is-6 is-offset-1' : 'is-6 is-offset-3 has-text-centered'")
            ...
            router-link.button.nice(:to="{ path: '/' + section + '/' + slug('leistungen') }") {{ c.b1 }}
      ...
      .container.content
        .columns
          .text.column.is-6.is-offset-3.has-text-centered
            ...
            p {{ c.t8 }}
            router-link.button.nice(:to="{ path: '/' + section + '/' + slug('referenzen') }")  {{ linkName('referenzen') }}
      ...
      .container.content
        .columns
          .text.column(:class="section==='offshore' ? 'is-5 is-offset-2' : 'is-6 is-offset-3 has-text-centered'")
            ...
            router-link.button(:to="{ path: '/' + section + '/team' }")  Team
      ...
      .container.content
        .columns
          .text.column.is-6.is-offset-3.has-text-centered
            ...
            router-link.button.nice(:to="{ path: '/' + section + '/' + slug('kontakt') }")  {{ linkName('kontakt') }}
</template>
